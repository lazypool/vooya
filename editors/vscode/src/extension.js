// VS Code supplies this host API at runtime. Keep editor logic in TypeScript
// while its host boundary remains intentionally untyped for now.
// @ts-nocheck
...
export async function deactivate() {
    if (storageRoot)
        await cleanupBridgeStorage(storageRoot);
}
