...
Semifold is Vooya's only version planner. The seven release packages form one
...
seven package IDs with the same bump level. This is deliberate: Semifold's Node
