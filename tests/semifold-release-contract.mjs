...
try {
  ...
  for (const id of ["vooya-compiler", "vooya-core", "vooya-build-core", "vooya-vite", "vooya-vue", "vooya-react", "vooya-rspack"]) {
  ...
  for (const directory of ["compiler", "core", "build-core", "vite", "vue", "react", "rspack"]) {
